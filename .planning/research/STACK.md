...
**If the target is Oracle ARM (`aarch64-linux`):**
...
**If the host is the very first fleet node:**
...
**If the fleet grows past one or two hosts:**
...
---
*Stack research for: modular NixOS homelab fleet infrastructure*
*Researched: 2026-03-21*
