...
Phase contract checks SHALL exist and SHALL be used to detect configuration drift before deployment, including ingress route-policy drift.
...
The operator surface SHALL provide commands for host status, service logs, and Tailscale health, and SHALL include ingress health visibility.
